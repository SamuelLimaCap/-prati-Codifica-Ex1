...
function runQuestion() {
    console.log("Para poder classificar o triângulo, será necessário passar os valores dos 3 lados do triângulo")
    ...
    if (a <=0 || b <= 0 || c <=0) {
        console.log("Algum dos valores informados está abaixo de 0. Um triângulo só existe se todos os lados forem maiores que 0")
        return
    }
